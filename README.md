# UI - Rails Engine UI Component Library
...
The UI gem provides the following components:
...
```ruby
gem "ui", path: "../ui"  # or from a gem server
```
...
The UI gem provides convenience helpers to quickly integrate it into your Rails engine.
...
module YourEngine
  ...
  class Engine < ::Rails::Engine
    ...
    # Setup assets and importmap with UI gem integration
    Ui::EngineHelpers.setup_assets(self, namespace: YourEngine)
...
**What this does:**
- Configures asset paths for your engine and the UI gem
- Sets up importmap that automatically includes UI gem's JavaScript and components
...
```ruby
module YourEngine
  class ApplicationViewComponent < Ui::ApplicationViewComponent
    def controller_name
...
**What this provides:**
- All UI gem helper methods (stimulus_controller, stimulus_target, etc.)
...
**What this does:**
- Uses the shared controller loader from UI gem
- Automatically registers Stimulus controllers with correct naming conventions
- Supports multiple namespaces (your engine + UI gem)
...
<html>
  <head>
    ...
    <!-- Include UI gem stylesheets -->
    <%= stylesheet_link_tag "ui/application", media: "all" %>
    <%= stylesheet_link_tag "ui/tailwind", media: "all" %>
    ...
    <!-- Importmap with UI gem integration -->
...
**Note:** UI gem's importmap is automatically included via `Ui::EngineHelpers.setup_importmap`

## Convenience Utilities

### Ruby Helpers

#### `Ui::EngineHelpers.setup_assets(engine_class, namespace:)`
Sets up asset paths for your engine with Propshaft/Sprockets support.

#### `Ui::EngineHelpers.setup_importmap(engine_class, namespace:)`
Configures importmap with:
- Your engine's importmap
- UI gem's importmap (automatic)
...
- Registers with correct naming conventions (e.g., `ui--button`, `your-engine--views--index`)
...
```bash
bundle exec rake app:ui:tailwind_engine_watch
```
